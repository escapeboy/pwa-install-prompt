...
const IOS_MODAL_CONTENT = `
      <div class="wepp-modal-content" style="padding: 20px;">
        <div class="wepp-modal-body">
          <h1 style="margin-top: 0; margin-bottom: 10px;">IOS App Installation Method</h1>
          <img id="wepp-logo" alt="logo" width="64" height="64" />
          <h2 id="wepp-name"></h2>
        </div>
        <p style="margin-block:4px;">
          1. Натиснете иконката в адресния бар
          ...
          Натиснете иконката в адресния бар
        </p>
        <p style="margin-block:4px;">2. Натисни 'Добавяне на началния екран'/ 'Add to Home Screen'.</p>

        <button id="wepp-skip-button">Добре съм, ще разглеждам през браузъра си.</button>
      </div>
    `;
const DEFAULT_MODAL_CONTENT = `
    <div class="wepp-modal-content" style="padding: 20px;">
      <div class="wepp-modal-body">
        <h1 style="margin-top: 0; margin-bottom: 10px;">Инсталирай като приложение</h1>
        <img id="wepp-logo" alt="logo" width="64" height="64" />
        <h2 id="wepp-name"></h2>
      </div>
      <button id="wepp-install-button" style="margin-top: 10px;padding: 10px;" disabled>Зареждане на информация...</button>
      <button id="wepp-skip-button" style="margin-top: 20px">
        Добре съм, ще разглеждам през браузъра си.
      </button>
    </div>
  `
